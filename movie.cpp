...
struct movie {
    ...
    movie(string t = "", string d = "", string y = "", vector<string> a = {} , vector<int> r = {} , bool aw = false)
...
void findmoviesbyactor(const string& actorname) {
    ...
    for (const auto& movie : moviedetails) {
        if (find(movie.second.actors.begin(), movie.second.actors.end(), actorname) != movie.second.actors.end()) {
...
int main() {
    ...
    movie movie1("The Shawshank Redemption", "Frank Darabont", "1994", {"Tim Robbins", "Morgan Freeman"}, {4, 2, 8, 1} , true);
    movie movie2("Top Gun", "Tony Scott", "1986", {"Tom Cruise", "Kelly McGillis"}, {9, 3, 6, 7});
    movie movie3("Django Unchained", "Quentin Tarantino", "2012", {"Jamie Foxx", "Christoph Waltz"}, {8, 5, 7, 2});
    movie movie4("The Dark Knight", "Christopher Nolan", "2008", {"Christian Bale", "Heath Ledger"}, {9, 3, 8, 2} , true);
    movie movie5("Inception", "Christopher Nolan", "2010", {"Leonardo DiCaprio", "Joseph Gordon-Levitt"}, {9, 2, 7, 4} , true);
    movie movie6("Interstellar", "Christopher Nolan", "2014", {"Matthew McConaughey", "Anne Hathaway"}, {8, 2, 8, 3} , true);
    movie movie7("Due Date", "Todd Phillips", "2010", {"Robert Downey Jr.", "Zach Galifianakis"}, {6, 7, 5, 4});
    movie movie8("21 Jump Street", "Phil Lord, Christopher Miller", "2012", {"Jonah Hill", "Channing Tatum"}, {8, 7, 5, 3});
    movie movie9("The Dictator", "Larry Charles", "2012", {"Sacha Baron Cohen", "Anna Faris"}, {7, 8, 3, 2});
    movie movie10("Superbad", "Greg Mottola", "2007", {"Michael Cera", "Jonah Hill"}, {5, 8, 4, 2});
    movie movie11("The Nice Guys", "Shane Black", "2016", {"Russell Crowe", "Ryan Gosling"}, {8, 7, 6, 3});
    movie movie12("Zodiac", "David Fincher", "2007", {"Jake Gyllenhaal", "Mark Ruffalo"}, {6, 3, 8, 2} , true);
    movie movie13("Shutter Island", "Martin Scorsese", "2010", {"Leonardo DiCaprio", "Mark Ruffalo"}, {7, 2, 9, 4});
    movie movie14("Seven", "David Fincher", "1995", {"Morgan Freeman", "Brad Pitt"}, {8, 3, 8, 1});
    movie movie15("John Wick", "Chad Stahelski", "2014", {"Keanu Reeves", "Michael Nyqvist"}, {9, 3, 7, 1});
    movie movie16("American Psycho", "Mary Harron", "2000", {"Christian Bale", "Justin Theroux"}, {7, 2, 8, 2});
    ...
    movie movie19("Prisoners", "Denis Villeneuve", "2013", {"Hugh Jackman", "Jake Gyllenhaal"}, {8, 2, 9, 2});
    movie movie20("The Prestige", "Christopher Nolan", "2006", {"Christian Bale", "Hugh Jackman"}, {7, 3, 8, 3} , true);
    movie movie21("Deadpool", "Tim Miller", "2016", {"Ryan Reynolds", "Morena Baccarin"}, {9, 8, 8, 1});
    movie movie22("Don't Look Up", "Adam McKay", "2021", {"Leonardo DiCaprio", "Jennifer Lawrence"}, {7, 6, 6, 3});
    movie movie23("Gone Girl", "David Fincher", "2014", {"Ben Affleck", "Rosamund Pike"}, {7, 3, 8, 4} , true);
    movie movie24("Drive", "Nicolas Winding Refn", "2011", {"Ryan Gosling", "Carey Mulligan"}, {8, 2, 7, 5});
    movie movie25("Iron Man", "Jon Favreau", "2008", {"Robert Downey Jr.", "Gwyneth Paltrow"}, {9, 4, 6, 3});
    movie movie26("The Avengers", "Joss Whedon", "2012", {"Robert Downey Jr.", "Chris Evans"}, {9, 3, 6, 2});
    movie movie27("Transformers", "Michael Bay", "2007", {"Shia LaBeouf", "Megan Fox"}, {8, 3, 6, 2} , true);
    movie movie28("Fight Club", "David Fincher", "1999", {"Brad Pitt", "Edward Norton"}, {9, 3, 9, 2} , true);
    movie movie29("The Adjustment Bureau", "George Nolfi", "2011", {"Matt Damon", "Emily Blunt"}, {7, 4, 6, 5});
    movie movie30("Home Alone", "Chris Columbus", "1990", {"Macaulay Culkin", "Joe Pesci"}, {5, 7, 4, 1});
    movie movie31("La La Land", "Damien Chazelle", "2016", {"Ryan Gosling", "Emma Stone"}, {4, 6, 5, 9} , true);
    ...
    movie movie34("Palm Springs", "Max Barbakow", "2020", {"Andy Samberg", "Cristin Milioti"}, {6, 7, 5, 3});
    movie movie35("Blade Runner", "Ridley Scott", "1982", {"Harrison Ford", "Rutger Hauer"}, {9, 2, 8, 2} , true);
    movie movie36("Rush Hour", "Brett Ratner", "1998", {"Jackie Chan", "Chris Tucker"}, {8, 7, 5, 1} , true);
    ...
    cout<<YELLOW<<"                         Welcome to Go Movies: Your Gateway to Unforgettable Movie Adventures!              "<<RESET<<endl;
    cout<<"                                       Get a movie recommended based on your preferences :-\n";
    cout<<CYAN<<"                      We suggest you the best movies based on preferences of movies that you give us !!\n"<<RESET;
    while (1){
